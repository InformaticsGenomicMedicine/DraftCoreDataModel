...
spdi_to_cvc_tests = [
    ("NC_000007.14:55181230::GGCT", cvc_example[0]),
    ("NC_000019.10:44908821:C:T", cvc_example[1]),
    ("NC_000007.14:55181219:T:", cvc_example[2]),
    ("NC_000023.11:32386322:T:GA", cvc_example[3]),
    ("NC_000013.11:32936731:C:C", cvc_example[4]),
    ("NC_000013.11:19993837:GT:GTGT", cvc_example[5]),
]

hgvs_to_cvc_tests = [
    ("NC_000007.14:g.55181230_55181231insGGCT", cvc_example[0]),
    ("NC_000019.10:g.44908822C>T", cvc_example[1]),
    ("NC_000007.14:g.55181220del", cvc_example[2]),
    ("NC_000023.11:g.32386323delinsGA", cvc_example[3]),
    ("NC_000013.11:g.32936732=", cvc_example[4]),
    ("NC_000013.11:g.19993838_19993839dup", cvc_example[5]),
]


vrs_to_cvc_tests = [
    (vrs_example[0], cvc_example[0]),
    (vrs_example[1], cvc_example[1]),
    (vrs_example[2], cvc_example[2]),
    (vrs_example[3], cvc_example[3]),
    (vrs_example[4], cvc_example[4]),
    (vrs_example[5], cvc_example[5]),
]
